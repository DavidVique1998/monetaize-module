 ...
 *   node scripts/test-consume-credits.js <JWT_TOKEN>
 *   JWT_TOKEN=tu_token node scripts/test-consume-credits.js
 */
 ...
 */
async function testConsumeWithToken(jwtToken) {
 ...
 */
async function testConsumeTokenValidations(jwtToken) {
...
async function main() {
  ...
  if (jwtToken) {
    ...
    log('  node scripts/test-consume-credits.js <JWT_TOKEN>');
    log('  o');
    log('  JWT_TOKEN=tu_token node scripts/test-consume-credits.js');
  }
