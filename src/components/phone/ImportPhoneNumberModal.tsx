          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm text-muted-foreground bg-card cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
              >
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm text-muted-foreground placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent bg-card"
                    onChange={(e) => {
              ...
              <>
                ...
                <div className="flex items-center space-x-3">
                  <input
                    ...
                    type="checkbox"
                    id="toll_free"
                    className="w-4 h-4 text-primary bg-muted border-gray-300 rounded focus:ring-primary focus:ring-2"
                  />
                  <label htmlFor="toll_free" className="text-sm font-medium text-muted-foreground">
