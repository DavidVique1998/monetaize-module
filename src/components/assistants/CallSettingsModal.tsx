        ...
        <div className="p-6 space-y-3">
          ...
          <div className="space-y-2">
              ...
              <select
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
              >
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-600">Generate signed URLs that expire after 24 hours</p>
            <button
                onClick={() => setOptInSignedUrl(!optInSignedUrl)}
                className={`w-full py-2 rounded-lg font-semibold transition-colors text-sm ${
                  optInSignedUrl ? 'bg-green-100 text-green-700 hover:bg-green-200' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                }`}
              >
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-600">The max ringing duration before the outbound call / transfer call is deemed no answer</p>
            <input
          ...
          >
            <div className="space-y-3">
              <div className="space-y-1">
                ...
                <p className="text-xs text-gray-600">Add background environment sound to make the call experience more realistic</p>
            <select
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-600">Control the volume of the ambient sound (0-2)</p>
              <input
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-600">Control how fast the agent responds after users finish speaking</p>
                  <input type="range" min="0" max="1" step="0.1" value={responsiveness} onChange={(e) => setResponsiveness(Number(e.target.value))} className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-blue-600" />
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-600">Control how sensitively AI can be interrupted by human speech</p>
                  <input type="range" min="0" max="1" step="0.1" value={interruptionSensitivity} onChange={(e) => setInterruptionSensitivity(Number(e.target.value))} className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-blue-600" />
                  <div className="flex justify-between text-xs text-gray-500">
                    <span>Low</span>
                    <span>High</span>
                  </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-600">Enables the agent to use affirmations like 'yeah' or 'uh-huh' during conversations, indicating active listening and engagement</p>
                <button
                  onClick={() => setEnableBackchanneling(!enableBackchanneling)}
                  className={`w-full py-2 rounded-lg font-semibold text-sm transition-colors ${
                    enableBackchanneling ? 'bg-green-100 text-green-700 hover:bg-green-200' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                  }`}
                >
                ...
                {enableBackchanneling && (
                  <div className="space-y-2">
                    ...
                    <input type="range" min="0" max="1" step="0.1" value={backchannelFrequency} onChange={(e) => setBackchannelFrequency(Number(e.target.value))} className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-blue-600" />
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-600">Converts text elements like numbers, currency, and dates into human-like spoken forms</p>
                <button
                  onClick={() => setEnableSpeechNormalization(!enableSpeechNormalization)}
                  className={`w-full py-2 rounded-lg font-semibold text-sm transition-colors ${
                    enableSpeechNormalization ? 'bg-green-100 text-green-700 hover:bg-green-200' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                  }`}
                >
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-600">Control how often AI will send a reminder message</p>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="text-sm font-medium text-gray-700">Trigger (seconds)</label>
                    <input type="number" min="0" max="60" value={reminderTrigger} onChange={(e) => setReminderTrigger(Number(e.target.value))} className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                  ...
                  <div>
                    ...
                    <input type="number" min="0" max="10" value={reminderMaxCount} onChange={(e) => setReminderMaxCount(Number(e.target.value))} className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500" />
          ...
          >
            ...
            <button
                ...
                className={`w-full py-2 rounded-lg font-semibold text-sm transition-colors ${
                  allowUserDtmf ? 'bg-green-100 text-green-700 hover:bg-green-200' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                }`}
              >
              ...
              {allowUserDtmf && (
                <>
                  <div className="space-y-2">
                    ...
                    <input type="number" min="1" max="60" value={dtmfTimeout} onChange={(e) => setDtmfTimeout(Number(e.target.value))} className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500" />
            </div>
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-gray-900">Termination Key</label>
                    <select value={dtmfTerminationKey} onChange={(e) => setDtmfTerminationKey(e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer">
          ...
          >
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <input type="number" value={webhookTimeout} onChange={(e) => setWebhookTimeout(Number(e.target.value))} className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-semibold text-gray-900">Voicemail Detection</label>
                <p className="text-xs text-gray-600">Hang up or leave a voicemail if a voicemail is detected</p>
            <button
              onClick={() => setVoicemailDetection(!voicemailDetection)}
                  className={`w-full py-2 rounded-lg font-semibold text-sm transition-colors ${
                    voicemailDetection ? 'bg-green-100 text-green-700 hover:bg-green-200' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                  }`}
                >
